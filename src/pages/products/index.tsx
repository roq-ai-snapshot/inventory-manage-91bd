...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'inventory.count', 'order.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['name.contains', 'description.contains', 'product_supplier.contains', 'category.contains'],
          ...params.filters,
        },
        'product',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'product_supplier', header: 'Product Supplier', accessorKey: 'product_supplier' },
