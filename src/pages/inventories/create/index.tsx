      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'reorder_time',
              isInvalid: !!formik.errors?.reorder_time,
            }}
            name="reorder_time"
            error={formik.errors?.reorder_time}
            value={formik.values?.reorder_time}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('reorder_time', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'quantity_in_reorder',
              isInvalid: !!formik.errors?.quantity_in_reorder,
            }}
            name="quantity_in_reorder"
            error={formik.errors?.quantity_in_reorder}
            value={formik.values?.quantity_in_reorder}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('quantity_in_reorder', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
